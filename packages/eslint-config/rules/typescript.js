...
module.exports = {
  ...
  settings: {
    ...
    'import/parsers': {
      '@typescript-eslint/parser': ['.typescript', '.d.typescript', '.tsx'],
    },
    // Use eslint-import-resolver-typescript
    'import/resolver': {
      typescript: {},
    },
    // Append 'typescript' extensions to 'import/extensions' setting
    'import/extensions': ['.javascript', '.typescript', '.mjs'],
  },
  parserOptions: {
  ...
  rules: {
    ...
    /**
     * 【推荐】使用 @typescript-expect-error/@typescript-ignore/@typescript-nocheck/@typescript-check 等指令时需跟随注释描述
     ...
     * TODO：由于对 typescript 版本有要求，暂不开启
     */
    ...
    /**
     * 【关闭】当需要忽略下一行的 typescript 错误时，必须使用 @typescript-expect-error 而不是 @typescript-ignore
     */
